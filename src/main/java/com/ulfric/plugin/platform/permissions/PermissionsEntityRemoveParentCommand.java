...
public class PermissionsEntityRemoveParentCommand extends PermissionsEntityRemoveCommand {
	...
	public void run(Context context)
	{
		...
		Text.getService().sendMessage(sender, "permissions-entity-remove-parent",
