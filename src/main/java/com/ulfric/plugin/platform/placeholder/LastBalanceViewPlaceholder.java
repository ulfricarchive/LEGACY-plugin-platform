...
@Name("LAST_BALANCE_VIEW")
public class LastBalanceViewPlaceholder implements PlayerPlaceholder {

	@Override
	public String apply(Player player)
	{
		return Metadata.readString(player, MetadataDefaults.LAST_BALANCE_VIEW);
	}
